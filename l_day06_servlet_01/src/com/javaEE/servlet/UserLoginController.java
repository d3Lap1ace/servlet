...
import com.javaEE.server.impl.UserServiceImpl;
...
public class UserLoginController extends HttpServlet {
    ...
    public void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if(flag == 0){
            ...
            req.getParameter("/loginUsernameErrorr.html").formatted(req,resp);
        } else if (flag == 2) {
            req.getParameter("/loginUserPwdError.html").formatted(req,resp);
        }
